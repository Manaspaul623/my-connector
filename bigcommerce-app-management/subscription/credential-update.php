...
if ($crm_type == 'SFDC') {
    ...
    $zohoAuthToken = NULL;
    $sfdc_user_name = trim($_REQUEST['vtigerUsername']);
    $sfdc_password = trim($_REQUEST['vtigerEndpoint']);
...
if ($re) {
    header("Location:https://".APP_DOMAIN."/bigcommerce-app-management/subscription/user-dashboard.php");
}

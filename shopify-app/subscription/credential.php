...
<html>
    <head>
        ...
        <title>Shopify Ecommerce connector</title>
                ...
                <div class="box-wrp">
                    ...
                    <form name="frmSubmit" id="sfdcInput" class="frmInput form-format" method="post" action="#">
                        ...
                        <div class="box">
							...
							<div id="vTigerCredDiv" style="display:<?php echo $valVtiger; ?>">
                ...
                $('body').on('click', '#credentialCheck', function (e) {
                    ...
                    if (crmType == 'ZOHO') {
                        ...
                        if (zohoAuthToken.length < 1) {
                            ...
                            $.ajax({
                                url: "/shopify-app/install/input-validation.php?type=validateZohoZuthToken",
                                method: "POST",
                        ...
                        if (zohoInvenAuthToken.length < 1) {
                            ...
                            $.ajax({
                                url: "/shopify-app/install/input-validation.php?type=validateZohoInvenZuthToken",
                                method: "POST",
                                ...
                                if (result == true) {
                                    swal("Correct!", "Your credentials are correct,We are updating...", "success");
                                    window.location = "credential-update.php?zohoInvenAuthToken=" + zohoInvenAuthToken + "&zohoInvenOrgID=" + zohoInvenOrgID;
                                } else {
                                    swal("Oops...", "Something went wrong!", "error");
                                }
                            }).fail(function (jqXHR, textStatus) {
                        ...
                        if (vtigerEndpoint.length < 1) {
                            ...
                            return false;
                             ...
                             $.ajax({
                                url: "/shopify-app/install/input-validation.php?type=validateVtigerToken",
                                method: "POST",
                                data: {vtigerUsername: vtigerUsername, vtigerEndpoint: vtigerEndpoint, vtigerAccessKey: vtigerAccessKey},
                                dataType: "json"
                            }).done(function (result) {
                                swal("Correct!", "Your credentials are correct,We are updating...", "success");
                                window.location = "credential-update.php?vtigerUsername=" + vtigerUsername + "&vtigerEndpoint=" + vtigerEndpoint + "&vtigerAccessKey=" + vtigerAccessKey;
                            }).fail(function (jqXHR, textStatus) {
                        ...
                        if (sfdc_user_name.length < 1) {
                            ...
                            $.ajax({
                                url: "/shopify-app/install/input-validation.php?type=validateSfdcInfo",
                                method: "POST",

...
if(!isset($_REQUEST['code'])) {
    ...
    header("Location: https://" . $shop . "/admin/oauth/authorize?client_id=" . SHOPIFY_CLIENT_ID . "&scope=read_products,read_product_listings,read_collection_listings,read_customers,read_orders&redirect_uri=https://www.showmeademo.com/shopify-app/install/index.php&state=" . $randomNum . "&grant_options[]=");
}
else{
